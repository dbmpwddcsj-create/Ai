...
def fallback_web_answer(query, web_results):
    ...
    answer += (
        "\nИнформация собрана из найденных в интернете источников. "
...
.b1 { width: 480px; height: 480px; background: radial-gradient(circle, #4a8dff, transparent 70%); top: -160px; left: -120px; }
.b2 { width: 380px; height: 380px; background: radial-gradient(circle, #6aa4ff, transparent 70%); bottom: -140px; right: -100px; }
.b3 { width: 300px; height: 300px; background: radial-gradient(circle, #2f6bdb, transparent 70%); top: 40%; left: 60%; opacity: 0.16; }
...
.brand-dot {
    ...
    box-shadow: 0 0 10px 2px rgba(74,141,255,0.7);
}
.icon-btn {
...
.pill-btn.gradient {
    background: linear-gradient(135deg, var(--accent-a), #6aa4ff);
    color: #fff; border: none; font-weight: 700;
    box-shadow: 0 4px 16px rgba(74,141,255,0.35), inset 0 1px 0 rgba(255,255,255,0.3);
}
...
.message { display: flex; margin-bottom: 22px; opacity: 0; transform: translateY(6px); animation: rise .32s ease forwards; }
...
.avatar {
    ...
    background: linear-gradient(135deg, var(--accent-a), #6aa4ff); margin-top: 2px;
    box-shadow: 0 3px 10px rgba(74,141,255,0.4);
}
...
.composer-box:focus-within { box-shadow: var(--glass-shadow), 0 0 0 2px rgba(74,141,255,0.45); border-color: rgba(74,141,255,0.5); }
...
.send-btn {
    ...
    background: linear-gradient(135deg, var(--accent-a), #6aa4ff); color: #fff;
    display: flex; align-items: center; justify-content: center;
    transition: transform .15s, opacity .15s;
    box-shadow: 0 4px 14px rgba(74,141,255,0.45), inset 0 1px 0 rgba(255,255,255,0.35);
}
...
.btn-primary {
    ...
    box-shadow: 0 4px 16px rgba(74,141,255,0.35);
}
.btn-ghost {
...
.plan-card.hl { border-color: rgba(74,141,255,0.55); background: rgba(74,141,255,0.10); }
...
.buy-btn {
    ...
    box-shadow: 0 3px 10px rgba(74,141,255,0.35);
}
...
.primary {
    background: linear-gradient(135deg, var(--accent-a), #6aa4ff); color: #fff; border: 0; border-radius: 12px;
    padding: 12px 18px; font-weight: 700; box-shadow: 0 4px 14px rgba(74,141,255,0.35);
}
